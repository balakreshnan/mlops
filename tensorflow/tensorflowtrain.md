# Train tensorflow model using Azure machine learning service using Azure DevOps
...
- Folder name called tf-minst
- create training file to retrain the model - tf_mnist.py
...
svc_pr_password = "ssssssssssssssssssssssssssssss"
...
svc_pr_password = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
 
svc_pr = ServicePrincipalAuthentication(
    tenant_id="xxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    service_principal_id="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    service_principal_password="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
